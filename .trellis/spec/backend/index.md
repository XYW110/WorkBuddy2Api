...
This directory contains guidelines for backend development, populated from real codebase analysis of the WorkBuddy2Api project (Node.js + TypeScript + Fastify).
